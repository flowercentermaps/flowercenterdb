...
//   static const PdfColor brandDark = PdfColor.fromInt(0xFF111111);
//   static const PdfColor lineGray = PdfColor.fromInt(0xFFBDBDBD);
//   static const PdfColor softGray = PdfColor.fromInt(0xFFF6F6F6);
//
...
//     );
//
//     final preparedItems = await _prepareItems(items);
//
//     pdf.addPage(
//       pw.MultiPage(
...
//                     pw.Text(
//                       'Trees & Arrangement General Trading LLC',
//                       style: pw.TextStyle(
//                         font: _fontBold,
//                         fontSize: 10.5,
//                       ),
...
//                     pw.Text(
//                       'Phone: +971 4 123 4567   |   Email: sales@treesarrangement.com',
...
//               crossAxisAlignment: pw.CrossAxisAlignment.start,
//               children: [
//                 _labelValueRow('To', _text(quote['customer_name'])),
...
//                 _labelValueRow('Contact', _text(quote['salesperson_contact'])),
//               ],
//             ),
//           ),
//         ),
...
//                   style: pw.TextStyle(
//                     fontSize: 8.4,
//                     font: descriptionLines.first == line ? _fontBold : _fontRegular,
//                   ),
//                 ),
//               ),
//             )
...
//                   : _text(quote['notes']),
//               style: const pw.TextStyle(fontSize: 8.7, lineSpacing: 2),
//             ),
//           ),
//         ),
//         pw.SizedBox(width: 10),
...
//         crossAxisAlignment: pw.CrossAxisAlignment.start,
//         children: [
//           _labelValueRow('Beneficiary', 'Trees & Arrangement General Trading LLC'),
//           _labelValueRow('Bank', 'Emirates NBD'),
//           _labelValueRow('Account No', '000123456789'),
//           _labelValueRow('IBAN', 'AE070260000000123456789'),
//           _labelValueRow('SWIFT', 'EBILAEAD'),
//         ],
//       ),
//     );
//   }
//
//   pw.Widget _buildTermsSection(Map<String, dynamic> quote) {
//     final terms = <String>[
//       'Prices are in AED and exclusive of VAT unless stated otherwise.',
//       'Delivery schedule is subject to material availability and site readiness.',
//       'Any variation in scope may affect price and delivery.',
//       'Advance payment may be required before production.',
//       'This quotation is valid for 15 days from the quotation date.',
//     ];
//
//     return _boxedSection(
...
//               crossAxisAlignment: pw.CrossAxisAlignment.start,
//               children: [
//                 pw.Text('• ', style: pw.TextStyle(font: _fontBold, fontSize: 8.4)),
//                 pw.Expanded(
//                   child: pw.Text(
//                     term,
...
//   //                       fontSize: 18,
//   //                       color: brandDark,
//   //                       fontFallback: [_fontArabicBold!, _fontArabicRegular!],
//   //                     ),
//   //                   ),
//   //                   pw.SizedBox(height: 4),
//   //                   pw.Text(
...
//                 child: pw.Text(
//                   line,
//                   textDirection: _containsArabic(line)
...
//                   ? 'Thank you for your inquiry. Please review the quotation details.'
//                   : _text(quote['notes']),
//               textDirection: _containsArabic(_text(quote['notes']))
//                   ? pw.TextDirection.rtl
//                   : pw.TextDirection.ltr,
//               style: pw.TextStyle(
//                 fontSize: 8.7,
...
//       final imagePath = _text(item['image_path']);
//
//       Uint8List? imageBytes = temporaryItemImages[itemId];
//
...
//                     pw.Text(
//                       'Email: sales@treesarrangement.com',
//                       style: pw.TextStyle(
//                         font: _fontRegular,
//                         fontSize: 7.5,
//                       ),
...
//                     // pw.SizedBox(height: 2),
//                     pw.Text(
//                      _pdfText( 'البريد  : sales@treesarrangement.com'),
//                       textDirection: pw.TextDirection.rtl,
//                       style: pw.TextStyle(
//                         font: _fontArabicRegular,
//                         fontSize: 7.5,
...
//                       textAlign: pw.TextAlign.right,
//                     ),                    pw.Text(
//                       _pdfText('الرفم الضريبي: 100123456700003'),
//                       textDirection: pw.TextDirection.rtl,
//                       style: pw.TextStyle(
//                         font: _fontArabicRegular,
//                         fontSize: 7.5,
...
//         crossAxisAlignment: pw.CrossAxisAlignment.start,
//         children: [
//           _labelValueRow('Bank Account Name', 'FLOWER CENTER LLC.'),
//           _labelValueRow('Bank Name', 'Abu Dhabi Islamic Bank - ( ADIB )'),
//           _labelValueRow('Account No', '15339805'),
//           _labelValueRow('IBAN', 'AE130500000000015339805'),
//           _labelValueRow('SWIFT Code', 'ABDIAEAD'),
              ...
              pw.Expanded(
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 0.5),
                    pw.Text(
                      _pdfText('البريد: info@flowercenter.ae'),
                      textDirection: pw.TextDirection.rtl,
                      style: pw.TextStyle(
                        font: _fontArabicRegular,
                        fontSize: 7.0,
  ...
  pw.Widget _buildBankDetailsSection() {
    return _boxedSection(
      ...
      child: pw.Column(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
        children: [
          _labelValueRow('Beneficiary', 'HAMASAT FLOWERS TR.'),
