...
/// Invoice PDF renderer for Hamasat Flowers TR.
/// Drop-in replacement for [InvoicePdfRenderer] — same [build] signature,
/// Hamasat branding (purple palette, bilingual header, hamasat logo).
class HmInvoicePdfRenderer {
    ...
    return pw.Container(
      ...
      child: pw.Column(
        children: [
              ...
              pw.Expanded(
                child: pw.Column(
                  ...
                  children: [
                    ...
                    _hLine('Email: info@hamasatflowers.com'),
                    _hLine('Dubai, United Arab Emirates'),
                    _hLine('TRN: 100425270400003'),
                    _hLine('Management: maheraktaa2000@gmail.com'),
                  ],
                ),
              ),
          ...
          pw.Container(height: 1.2, color: _brandPurple),
        ],
      ),
    );
  }
  ...
  pw.Widget _metaLine(String label, String value) => pw.Padding(
        ...
        child: pw.Row(
          ...
          children: [
            pw.Text('$label ',
                style: pw.TextStyle(
                    font: _fontRegular, fontSize: 8, color: _brandDark)),
            pw.Text(value,
                style: pw.TextStyle(font: _fontBold, fontSize: 8)),
          ],
        ),
      );
        ...
        pw.SizedBox(
          ...
          child: pw.Column(
            children: [
              ...
              _summaryRow(
                  'VAT (${vatPercent.toStringAsFixed(0)}%)', vatAmount),
              pw.Container(height: 0.8, color: _brandPurple),
  ...
  pw.Widget _buildPartialNote(double amountPaid, double balance) {
    return pw.Container(
      padding: const pw.EdgeInsets.all(10),
      decoration: pw.BoxDecoration(
        color: const PdfColor.fromInt(0xFFF3EEF8),
        border: pw.Border.all(color: _brandPurple, width: 0.8),
        borderRadius:
      ...
      child: pw.Column(
        children: [
          ...
          pw.Row(
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: [
              pw.Text('Hamasat Flowers TR. — Invoice',
                  style: pw.TextStyle(
                      font: _fontRegular,
                      fontSize: 7.5,
  ...
  String _fmtNum(dynamic v) => _num(v).toStringAsFixed(2);
}
