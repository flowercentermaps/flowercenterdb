...
class FCQuotationPdfRenderer {
  FCQuotationPdfRenderer({
  ...
  static const PdfColor brandGold = PdfColor.fromInt(0xFFba8c50);
  ...
  static const PdfColor softGray = PdfColor.fromInt(0xFFf1e8dc);
              ...
              pw.Expanded(
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 0.5),
                    pw.Text(
                      _pdfText('الرقم الضريبي: 100393229800003'),
                      textDirection: pw.TextDirection.rtl,
                      style: pw.TextStyle(
                        font: _fontArabicRegular,
                        fontSize: 7.0,
  ...
  pw.Widget _buildBankDetailsSection() {
    return _boxedSection(
      ...
      child: pw.Column(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
        children: [
          _labelValueRow('Beneficiary', 'FLOWER CENTER LLC'),
