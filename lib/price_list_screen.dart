...
//         icon: Icon(_isAdmin ? Icons.admin_panel_settings_rounded : Icons.qr_code_scanner_rounded),
//         label: Text(_isAdmin ? 'Actions' : 'Scan'),
//       ),
//       body: SafeArea(
//         child: Column(
//           children: [
...
//       const SnackBar(content: Text('Add item form goes here')),
//     );
//   }
...
//                       fit: BoxFit.cover,
//                       // placeholder:  (_) => _ImagePlaceholder(),
//                     )
//                       // child: Image.network(
//                       //   imageUrl,
//                       //   fit: BoxFit.cover,
...
//                   runSpacing: 8,
//                   children: [
//                     _SmallPriceBox(label: 'R', value: formatPrice(priceR)),
//                     _SmallPriceBox(
//                       label: 'TOTAL',
...
//                             const SnackBar(
//                               content: Text(
//                                 'Quotation generation template will be added next.',
//                               ),
//                             ),
//                           );
//                         },
...
//                   subtitle: const Text('Global and per-user price restrictions'),
//                   onTap: () {
//                     Navigator.pop(context);
...
//                   selectedPriceKey: _selectedPriceKeyForItem(_filteredItems[index]),
...
//                       final allowed = (pricePermissions[option.key] ?? true) && exists;
...
//
//   @override
//   State<PricePermissionsScreen> createState() => _PricePermissionsScreenState();
// }
//
...
//                   SwitchListTile(
//                     contentPadding: EdgeInsets.zero,
//                     title: const Text('Block all prices for all users'),
...
//                 ),
//                 FilledButton.icon(
//                   onPressed: (_isSavingAllUsers || _filteredUsers.isEmpty)
//                       ? null
...
//                   )
//                       : const Icon(Icons.save_outlined),
//                   label: Text(_isSavingAllUsers ? 'Saving...' : 'Save All Visible Users'),
//                 ),
//               ],
//             ),
//             const SizedBox(height: 12),
...
//                     SwitchListTile(
//                       contentPadding: EdgeInsets.zero,
//                       title: const Text('Block all prices for this user'),
//                       value: blockAll,
//                       onChanged: (value) {
//                         setState(() {
...
//                           onSelected: (selected) {
//                             setState(() {
//                               final set = _userBlockedKeys.putIfAbsent(
//                                 profileId,
//                                     () => <String>{},
//                               );
//                               if (selected) {
...
//         SnackBar(
//           content: Text(
//             'Quotation ${insertedQuotation['quote_no']} created successfully.',
//           ),
//         ),
//       );
//     } catch (e) {
