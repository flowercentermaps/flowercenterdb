...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _loadAlerts() async {
    ...
    try {
      ...
      final leadMap = <String, Map<String, dynamic>>{};
  ...
  String _leadLabel(String leadId) {
    final lead = _leadMap[leadId];
    if (lead == null) return 'Unknown lead';
    final name = _text(lead['name']);
    final company = _text(lead['company_name']);
    final phone = _text(lead['phone']);
          ...
          _NotificationSection(
            ...
            trailing: _SectionActionButton(
              ...
              onPressed: () => _clearSection(
                category: 'overdue_followups',
                entityType: 'follow_up',
                entityIds: _overdueFollowUps.map((e) => _text(e['id'])).toList(),
              ),
            ),
            child: _overdueFollowUps.isEmpty
                ...
                ? Column(
              children: [
                const _DesktopFollowUpAlertHeader(),
                const SizedBox(height: 8),
                ..._overdueFollowUps.map(
                      (item) => Padding(
                    padding: const EdgeInsets.only(bottom: 8),
                    child: _DesktopFollowUpAlertRow(
                      leadLabel: _leadLabel(_text(item['lead_id'])),
                      dueAt:
                      _formatDateTime(_parseDateTime(item['due_at'])),
                      notes: _text(item['notes']),
                      assignee: _userLabel(_text(item['assigned_to'])),
                      tone: _AlertTone.overdue,
                      onDismiss: () => _dismissOne(
              ...
              children: _overdueFollowUps
                  ...
                  child: _MobileFollowUpAlertCard(
                    leadLabel: _leadLabel(_text(item['lead_id'])),
                    dueAt: _formatDateTime(
                        _parseDateTime(item['due_at'])),
                    notes: _text(item['notes']),
          ...
          _NotificationSection(
            ...
            trailing: _SectionActionButton(
              ...
              onPressed: () => _clearSection(
                category: 'due_today_followups',
                entityType: 'follow_up',
                entityIds: _dueTodayFollowUps.map((e) => _text(e['id'])).toList(),
              ),
            ),
            child: _dueTodayFollowUps.isEmpty
          ...
          _NotificationSection(
            ...
            trailing: _SectionActionButton(
              ...
              onPressed: () => _clearSection(
                ...
                entityType: 'follow_up',
                entityIds:
                _dueTomorrowFollowUps.map((e) => _text(e['id'])).toList(),
              ),
            ),
            child: _dueTomorrowFollowUps.isEmpty
          ...
          _NotificationSection(
            ...
            trailing: _SectionActionButton(
              ...
              onPressed: () => _clearSection(
                category: 'assignment_logs',
                entityType: 'activity_log',
                entityIds: _assignmentLogs.map((e) => _text(e['id'])).toList(),
              ),
            ),
            child: _assignmentLogs.isEmpty
                ...
                ? Column(
              children: [
                const _DesktopAssignmentAlertHeader(),
                const SizedBox(height: 8),
                ..._assignmentLogs.map(
                      (log) => Padding(
                    padding: const EdgeInsets.only(bottom: 8),
                    child: _DesktopAssignmentAlertRow(
                      leadLabel: _leadLabel(_text(log['lead_id'])),
                      actorLabel: _userLabelFromLogMetaOrId(
                        log: log,
                        idKey: 'actor_id',
              ...
              children: _assignmentLogs
                  .map(
                    (log) => Padding(
                  padding: const EdgeInsets.only(bottom: 10),
                  child: _MobileAssignmentAlertCard(
                    leadLabel: _leadLabel(_text(log['lead_id'])),
                    actorLabel: _userLabelFromLogMetaOrId(
                      log: log,
                      idKey: 'actor_id',
...
class _DesktopFollowUpAlertHeader extends StatelessWidget {
  const _DesktopFollowUpAlertHeader();
...
class _DesktopFollowUpAlertRow extends StatelessWidget {
  final String leadLabel;
  final String dueAt;
  final String notes;
  final String assignee;
  ...
  const _DesktopFollowUpAlertRow({
    required this.leadLabel,
    required this.dueAt,
    required this.notes,
    required this.assignee,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF101010),
        borderRadius: BorderRadius.circular(14),
        border: Border.all(color: _toneColor.withOpacity(0.45)),
      ),
      child: Row(
        children: [
          Expanded(
...
class _MobileFollowUpAlertCard extends StatelessWidget {
  final String leadLabel;
  final String dueAt;
  final String notes;
  final String assignee;
  ...
  const _MobileFollowUpAlertCard({
    required this.leadLabel,
    required this.dueAt,
    required this.notes,
    required this.assignee,
...
class _DesktopAssignmentAlertHeader extends StatelessWidget {
  const _DesktopAssignmentAlertHeader();
...
class _DesktopAssignmentAlertRow extends StatelessWidget {
  final String leadLabel;
  final String actorLabel;
  final String oldOwnerLabel;
  final String newOwnerLabel;
  ...
  const _DesktopAssignmentAlertRow({
    required this.leadLabel,
    required this.actorLabel,
    required this.oldOwnerLabel,
    required this.newOwnerLabel,
...
class _MobileAssignmentAlertCard extends StatelessWidget {
  final String leadLabel;
  final String actorLabel;
  final String oldOwnerLabel;
  final String newOwnerLabel;
  ...
  const _MobileAssignmentAlertCard({
    required this.leadLabel,
    required this.actorLabel,
    required this.oldOwnerLabel,
    required this.newOwnerLabel,
