...
//
//     final dismissals = (dismissalsResponse as List)
...
//       }
//
//       final overdueResponse = await overdueQuery.order('due_at', ascending: true);
...
//                     dueAt: _formatDateTime(_parseDateTime(item['due_at'])),
...
//                     ),
//                     createdAt:
//                     _formatDateTime(_parseDateTime(log['created_at'])),
//                   ),
//                 ),
//               )
//                   .toList(),
...
//                   border: Border.all(color: _toneColor.withOpacity(0.4)),
//                 ),
//                 child: Text(
//                   _toneLabel,
//                   style: TextStyle(
...
// If you still have _scheduleRealtimeRefresh in the file, remove it completely.
  ...
  //
  //   _realtimeChannel = _supabase
  //       .channel('crm-notifications-$channelKey')
  //       .onPostgresChanges(
  //     event: PostgresChangeEvent.all,
  //     schema: 'public',
  //     table: 'follow_ups',
